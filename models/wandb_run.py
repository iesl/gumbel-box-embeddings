...
def make_same(source_name, target_name, params_dict):
    if source_name in params_dict:
        params_dict[target_name] = params_dict[source_name]
...
def setup_wandb():
    ...
    custom_constraints = [lambda params: make_same(
        'overrides.dataset_reader.number_negative_samples', 'overrides.model.neg_samples_in_dataset_reader', params)]
    # init wandb
    run = wandb.init()
